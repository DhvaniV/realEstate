...
import { backgroundColor, black, blue, grey, headingTxt, primaryColor, shadowColor, yellow } from './Colors';
  ...
  const renderItem = ({ item }: any) => {
    return (
      <View style={styles.mainView}>
        ...
        <View style={styles.row}>
          <Text style={[styles.address, { color: headingTxt }]}>{item.funding_type === 'public' ? <Text>PUBLIC</Text> : <Text>PRIVATE</Text>}</Text>
        ...
        <View style={styles.row1}>
          <View style={styles.student_View}>
            <Text style={styles.studen_txt}>Total Students:{item.student_count}</Text>
          </View>
        </View>
      </View>
    )
